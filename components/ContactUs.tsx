    ...
    <section className="pt-32 pb-16 bg-black min-h-screen relative overflow-hidden flex flex-col justify-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
             <a href="https://wa.me/447411576834" target="_blank" rel="noopener noreferrer" className="block bg-zinc-900/50 border border-zinc-800 p-10 rounded-2xl hover:border-green-500/50 hover:bg-zinc-900 transition-all group cursor-pointer">
                <div className="flex flex-col items-center text-center gap-6">
                   ...
                   <div>
                      ...
                      <span className="text-green-500 font-bold text-xl group-hover:text-green-400 transition-colors bg-green-500/10 px-4 py-2 rounded-lg group-hover:bg-black/30" dir="ltr">+44 7411 576834</span>
                   </div>
                </div>
             </a>
