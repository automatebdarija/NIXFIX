                            ...
                            {devicesList.map((key) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full text-left p-4 rounded-xl flex items-center gap-4 transition-all duration-300 border ${isSelected
                        ...
                        <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6 md:p-10 backdrop-blur-sm h-full">
                            ...
                            <div className="mt-10 pt-8 border-t border-zinc-800 flex items-start gap-4 bg-blue-900/10 p-4 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <a href="https://wa.me/447735029723" target="_blank" rel="noopener noreferrer" className="inline-block mt-3 text-brand-gold text-sm font-bold hover:text-white transition-colors border-b border-brand-gold pb-0.5">
