      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-stretch px-2">
          {PLANS.map((plan, index) => {
            ...
            const whatsappLink = `https://wa.me/447411576834?text=${encodeURIComponent(message)}`;
            
            return (
              <div 
                key={index}
                className={`relative rounded-[2.5rem] p-8 md:p-10 flex flex-col transition-all duration-500 group h-full ${
                  isCenter 
              ...
              >
                ...
                <a 
                  ...
                  className={`block text-center w-full py-5 rounded-2xl font-black text-sm uppercase tracking-widest transition-all mb-4 border ${
                      isCenter 
