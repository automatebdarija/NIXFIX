        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/447411576834" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded bg-zinc-900 flex items-center justify-center text-gray-400 hover:bg-brand-gold hover:text-black transition-colors" aria-label="Chat on WhatsApp">
            ...
            <ul className="space-y-4">
              <li className="flex gap-4 group cursor-pointer">
                <div className="w-16 h-12 bg-zinc-800 rounded overflow-hidden shrink-0">
                  <img src="/images/article-firestick.webp" className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity" alt="Article" />
                </div>
              ...
              <li className="flex gap-4 group cursor-pointer">
                <div className="w-16 h-12 bg-zinc-800 rounded overflow-hidden shrink-0">
                  <img src="/images/article-review.webp" className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-opacity" alt="Review" />
                </div>
                <div className="flex flex-col justify-center">
